...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let formatRGBA: any // eslint-disable-line @typescript-eslint/no-explicit-any
      let formatRG: any // eslint-disable-line @typescript-eslint/no-explicit-any
      let formatR: any // eslint-disable-line @typescript-eslint/no-explicit-any
    ...
    function generateColor(): ColorRGB {
      const c: ColorRGB = { r: 0.12, g: 0, b: 0.7 }
      return c
    }
  ...
  return (
    <div className="pointer-events-none fixed top-0 left-0 h-full w-full">
      <canvas
        ref={canvasRef}
        id="fluid"
        className="block h-screen w-screen opacity-10"
      ></canvas>
    </div>
  )
}
